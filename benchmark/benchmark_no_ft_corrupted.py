...
def run_comprehensive_benchmark():
    ...
    print(f"🎲 Random seed: {random_seed} (for reproducibility)")    # Count available benchmarks
    ...
    if HYPEROPT_AVAILABLE:        library_count += 1
        print(
        ...
        print(
            f"\n❌ [{benchmark_count + 1}/{total_benchmarks}] Hyperopt not available, skipping..."
        )
    ...
    if OPTUNA_AVAILABLE:
        benchmark_count += 1
        print(
            f"\n🎯 [{benchmark_count}/{total_benchmarks}] Running Optuna benchmark..."
        )
        ...
        print(
            f"\n❌ [{benchmark_count + 1}/{total_benchmarks}] Optuna not available, skipping..."
        )
    ...
    if SKLEARN_AVAILABLE:
        benchmark_count += 1
        print(
            f"\n🧪 [{benchmark_count}/{total_benchmarks}] Running sklearn benchmark..."
        )
        ...
        print(
            f"\n❌ [{benchmark_count + 1}/{total_benchmarks}] Sklearn benchmarks not available, skipping..."
        )
    ...
    print(f"📊 Completed {benchmark_count}/{total_benchmarks} benchmarks")
